...
//食品酒水里面的轮播图
    ...
    timer1 = setInterval(autoPlay,4000);
	 ...
	 $(".right").click(function(){
	 	...
	 	if(flag){
	 		flag = false;	
		 	$(".content_carousel .lun_list").prepend( $(".lun_list li:last") );
		 	$(".content_carousel .lun_list").css("margin-left",-339);
		 	$(".content_carousel .lun_list").animate({"margin-left":0},1000,function(){
		 		flag = true;
		 	})
	 	}
	 })
